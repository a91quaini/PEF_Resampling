...
## Bootsrapping the Adaptive Lasso estimator
...
\item however if we stratify the performance of the MB by different choices of $a$ we sometimes get much better results
...
\includegraphics[scale=0.4]{Case1}


## Numerical results

\includegraphics[scale=0.4]{Case2}
...
\begin{itemize}
\item the JAB estimates of $a$ are very good for Case (i) but deteriorates for the other two cases
