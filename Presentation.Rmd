...
2. Threshold the components of the Lasso estimator $\beta_n$ at $a_n$, and define the modified Lasso estimator $\tilde{\beta}_{n,j} = \beta_{n,j} \mathbbm{1}(\beta_{n,j} \geq a_n)$ for $j=1,...,p$.
